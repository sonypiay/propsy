        ...
        <div class="uk-margin modal-form">
          ...
          <div class="uk-margin-bottom uk-overflow-auto">
            ...
            <div class="uk-grid-small uk-child-width-auto" uk-grid>
              <div v-for="project in project_selected.results">
          ...
          <a @click="recruitMarketing(marketing_detail.mkt_user_id)" class="uk-button uk-button-primary modal-form-add">Rekrut Marketing</a>
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    detailMarketing( mkt )
    {
      ...
      axios({
        ...
        this.project_selected.results.forEach( p => {
