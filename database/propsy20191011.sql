...
insert  into `log_project_request`(`log_id`,`log_message`,`request_id`,`log_date`) values (32,'Sony Darmawan mengajukan pemesanan unit Rumah Sharia Tipe 2','REQ201910110001','2019-10-11 22:46:08');
...
insert  into `project_request`(`request_id`,`dev_user_id`,`customer_id`,`unit_type_id`,`request_message`,`status_request`,`isReviewed`,`created_at`,`updated_at`,`seqid`,`installment`) values ('REQ201910110001','DEV0002','CUST0001','UNIT0009','Halo Sharia Land, saya ingin mengajukan pemesenan unit Rumah Sharia Tipe 2.','waiting_response','N','2019-10-11 22:46:08','2019-10-11 22:46:08',8,9);
...
insert  into `project_unit_type`(`unit_type_id`,`unit_name`,`unit_slug`,`unit_floor`,`unit_lb`,`unit_lt`,`unit_kt`,`unit_km`,`unit_price`,`unit_description`,`unit_status`,`unit_watt`,`unit_facility`,`unit_thumbnail`,`project_id`,`created_at`,`updated_at`,`seqid`) values ('UNIT0001','Rumah Sharia Tipe 1','rumah-sharia-tipe-1',2,56,60,3,2,158850000,'<p><span style=\"color: rgb(51, 51, 51);\">Jawa Ipsum gelung kalung ayam manah jawah, luh bebed kancing. Sapu sima peksi susu piring tuwi enjing mucal dipun pendhet wos? Peksi cariyos, sakit suku epek-epek ngulemi pedhang, untu manah nyukani maesa. Bidal minggat supena ngulemi? Peksi dhateng, kangge; kinten nyepeng ayam toya peksi, \"sima wilujeng maos sirah kuping ngadeg dolan makarya.\" Jejeran wawarat embok saweg mantun ajrih benang ningali gujeng pedhang tumut swanten awon.</span></p><p><br></p><p><span style=\"color: rgb(51, 51, 51);\">Sekar inggih surya kangge; gegriya purun mripat aken kajang. Dangu dhateng iket cepeng kekesahan madeg ilat benter, gelung sima, cemeng. Supe tangan, dhuwung ningali pupak manah kepireng mangga nanem wiar epek-epek sumerep yatra sekar nanem tirah.</span></p>','available',3200,'Telepon,Air Panas,Akses Internet / Wifi,Pendingin Ruangan (AC),Garasi,Halaman Terbuka,Taman','unit-6HggPNknJmjFDBBiWtzfpcRvn6QUCil4jkc3w1oc.jpeg','PRY0001','2019-10-11 17:45:57','2019-10-11 20:30:28',8),('UNIT0009','Rumah Sharia Tipe 2','rumah-sharia-tipe-2',2,30,60,2,1,132758000,'<p>Jawa Ipsum gelung kalung ayam manah jawah, luh bebed kancing. Sapu sima peksi susu piring tuwi enjing mucal dipun pendhet wos? Peksi cariyos, sakit suku epek-epek ngulemi pedhang, untu manah nyukani maesa. Bidal minggat supena ngulemi? Peksi dhateng, kangge; kinten nyepeng ayam toya peksi, \"sima wilujeng maos sirah kuping ngadeg dolan makarya.\" Jejeran wawarat embok saweg mantun ajrih benang ningali gujeng pedhang tumut swanten awon.</p><p>Sekar inggih surya kangge; gegriya purun mripat aken kajang. Dangu dhateng iket cepeng kekesahan madeg ilat benter, gelung sima, cemeng. Supe tangan, dhuwung ningali pupak manah kepireng mangga nanem wiar epek-epek sumerep yatra sekar nanem tirah.</p><p>Segawon <a href=\"http://sikatsuket.blogspot.com/\" rel=\"noopener noreferrer\" target=\"_blank\">nyukani ulem-ulem</a> cawis kalung kula sirah; gujeng nedha. Cariyos nanem surya kathok nginten lenggah, tetak unyeng-unyeng wicanten gulu.</p>','booked',2200,'Telepon,Pendingin Ruangan (AC),Air Panas','unit-GtGboMey0JhWq0bf2dCA9AyyXf3HrJZFgzNjPT9X.jpeg','PRY0001','2019-10-11 21:19:26','2019-10-11 22:46:08',9);
