...
export default {
  ...
  methods: {
    ...
    getReportUnit( p )
    {
      ...
      var url = this.$root.url + '/developer/report/get_unit/sold?page=' + this.getunit.paginate.current_page + '&' + param;
    ...
    onSaveAs( file )
    {
      ...
      var param = 'start_date=' + start_datepicker + '&end_date=' + end_datepicker;
      var url = this.$root.url + '/developer/report/save_report/sold?' + param;
