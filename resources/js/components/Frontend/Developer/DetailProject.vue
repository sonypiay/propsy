<template>
  <div>
    <div class="uk-card dashboard-content">
      ...
      <div id="modal-view-unit-type" class="uk-modal-full" uk-modal>
        <div class="uk-modal-dialog uk-modal-body uk-height-viewport">
          <a class="uk-modal-close-large uk-modal-close" uk-close></a>
            ...
            <div class="uk-margin">
              ...
              <div v-else class="modal-form">
                ...
                <table v-else class="uk-table uk-table-divider uk-table-small uk-table-hover uk-table-striped uk-table-middle">
                  ...
                  <tbody>
                    <tr v-for="unit_tipe in project_unit_tipe.results">
                      <td class="uk-width-small">
                        ...
                        <a @click="" class="uk-button uk-button-primary uk-button-small modal-submit"><i class="icon ion-ios-trash"></i></a>
                      </td>
                      <td class="uk-width-small">
                        <a class="uk-button uk-button-primary uk-button-small modal-submit">Lihat Cicilan</a>
                      </td>
