    ...
    <form class="uk-form-stacked content-form" @submit.prevent="onChangeEmail">
      <div class="uk-margin">
        ...
        <div class="uk-form-controls">
          <input type="email" v-model="forms.email" :placeholder="session_user.dev_email" class="uk-width-1-2 uk-input content-form-input">
        </div>
      </div>
      <div class="uk-margin">
...
export default {
  ...
  methods: {
    onChangeEmail()
    {
      ...
      axios({
        method: 'put',
        url: this.$root.url + '/developer/profile/change_email',
        ...
        this.session_user.dev_email = this.forms.email;
        this.forms.email = '';
