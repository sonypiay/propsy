...
insert  into `project_request`(`request_id`,`request_unique_id`,`dev_user_id`,`customer_id`,`unit_type_id`,`request_message`,`request_note`,`status_request`,`isReviewed`,`created_at`,`updated_at`) values (1,'REQ00001-20191001',1,1,1,'Halo PT Agung Podomoro Land Tbk, saya ingin mengajukan pemesenan unit.',NULL,'accept','Y','2019-10-01 21:17:20','2019-10-01 21:23:37'),(2,'REQ00002-20191001',1,1,4,'Halo PT Agung Podomoro Land Tbk, saya ingin mengajukan pemesenan unit.',NULL,'accept','Y','2019-10-01 21:25:30','2019-10-01 21:44:48');
