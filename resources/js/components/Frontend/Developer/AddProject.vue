          ...
          <div class="uk-form-controls">
            <div class="uk-placeholder uk-text-center">
              <div uk-form-custom>
                ...
                <input type="file" @change="selectedSitePlan" accept="image/*" multiple>
            ...
            <div v-show="forms.project_site_plan.length !== 0" class="uk-margin uk-grid-small uk-grid-match" uk-grid>
              <div v-for="(site_plan, index) in forms.project_site_plan" class="uk-width-1-5">
                ...
                <button @click="deleteSitePlan( index )" class="uk-width-1-1 uk-button uk-button-primary uk-button-small dash-btn dash-btn-action" uk-icon="close"></button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="uk-form-controls">
            <div class="uk-placeholder uk-text-center">
              <div uk-form-custom>
                <span uk-icon="icon: cloud-upload"></span>
                <span class="uk-text-middle">Attach binaries by dropping them here or</span>
                <input type="file" @change="selectedThumbnail" accept="image/*">
                <span class="uk-link uk-text-middle">selecting one</span>
              </div>
            </div>
